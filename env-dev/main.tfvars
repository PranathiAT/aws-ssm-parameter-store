parameters = [
  ...
  {name: "dev.user.redis_host",value = "redis-dev-elasticache.ralt9t.ng.0001.use1.cache.amazonaws.com" },
  {name: "dev.user.mongo",value = "DOCUMENTDB=true"},
  {name: "dev.user.mongo_endpoint",value = "mongodb-dev.pdevops.online"},
  {name: "dev.cart.redis_host",value = "redis-dev-elasticache.ralt9t.ng.0001.use1.cache.amazonaws.com" },
